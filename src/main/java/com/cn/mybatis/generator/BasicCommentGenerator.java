 ...
 * @author wl
 */
public class BasicCommentGenerator implements CommentGenerator {
...
//        sb.append(" * This class corresponds to the database table "); //$NON-NLS-1$
        ...
        topLevelClass.addJavaDocLine(" * @author " + classCommentAuthor);
        topLevelClass.addJavaDocLine(" * @date " + getDateString());
        topLevelClass.addJavaDocLine(" * @version " + classCommentVersion);
...
//        innerEnum.addJavaDocLine(sb.toString());
    ...
    public void addFieldComment(final Field field,
        ...
        if (addRemarkComments && StringUtility.stringHasValue(remarks)) {
        	...
        	sb2.append(" * Database Column Remarks:");
            final String[] remarkLines = remarks.split(System.getProperty("line.separator"));  //$NON-NLS-1$
            for (String remarkLine : remarkLines) {
            	sb2.append(" " + remarkLine);  //$NON-NLS-1$
            }
...
//        field.addJavaDocLine(" *"); //$NON-NLS-1$
    ...
    public void addFieldComment(final Field field, final IntrospectedTable introspectedTable) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(" * "+introspectedTable.getFullyQualifiedTable() + " " +field.getName());
        field.addJavaDocLine(sb.toString());
...
//            sb.append(".");
        ...
        if(method.getReturnType()!=null && method.getReturnType().getShortName()!=null){
...
//            sb.append(".");
        ...
        sb.append(" * @return "+(introspectedColumn.getActualColumnName()==null ? "":introspectedColumn.getActualColumnName()));
//        sb.append(" .");
        method.addJavaDocLine(sb.toString());
        addJavadocTag(method, false);
...
//        sb.append(introspectedColumn.getActualColumnName());
    ...
    public void addClassComment(final InnerClass innerClass,
        ...
        innerClass.addJavaDocLine(" * @author " + classCommentAuthor);
        innerClass.addJavaDocLine(" * @date " + getDateString());
        innerClass.addJavaDocLine(" * @version " + classCommentVersion);
	...
	public void addMapperClassComment(Interface mapperInterface, IntrospectedTable introspectedTable) {
        ...
        mapperInterface.addJavaDocLine("/**"); //$NON-NLS-1$

        final String remarks = introspectedTable.getRemarks();
        if (addRemarkComments && StringUtility.stringHasValue(remarks)) {
        	StringBuilder sb2 = new StringBuilder();
        	sb2.append(" * Database Table Remarks:");
            final String[] remarkLines = remarks.split(System.getProperty("line.separator"));  //$NON-NLS-1$
            for (String remarkLine : remarkLines) {
            	sb2.append(" " + remarkLine);  //$NON-NLS-1$
            }
            mapperInterface.addJavaDocLine(sb2.toString());
        }
        ...
        addJavadocTag(mapperInterface, true);
        
        mapperInterface.addJavaDocLine(" * @author " + classCommentAuthor);
        mapperInterface.addJavaDocLine(" * @date " + getDateString());
        mapperInterface.addJavaDocLine(" * @version " + classCommentVersion);
